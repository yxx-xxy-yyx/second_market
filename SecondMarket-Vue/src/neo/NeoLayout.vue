  ...
  <div class="min-h-[100dvh] bg-[var(--bg-color)]">
    ...
    >
      <div class="h-[64px] flex items-center justify-around">
        ...
        <button
          class="neo-tab"
          :class="{ active: isActive('/neo/campus-categories') }"
          @click="router.push('/neo/campus-categories')"
        >
          <el-icon :size="22"><Grid /></el-icon>
          <span class="neo-tab-label">{{ $t('neo.tabs.campus') }}</span>
        </button>
        ...
        <button
          class="neo-tab"
          :class="{ active: isActive('/neo/notification-center') }"
          @click="router.push('/neo/notification-center')"
        >
          <el-icon :size="22"><Bell /></el-icon>
          <span class="neo-tab-label">{{ $t('neo.tabs.notice') }}</span>
        </button>
      </div>
    </nav>
  </div>
...
import { Bell, Grid, House, ShoppingCart } from '@element-plus/icons-vue'
