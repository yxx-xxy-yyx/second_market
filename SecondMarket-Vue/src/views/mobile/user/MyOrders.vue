  ...
  <div class="px-3 py-4 space-y-4">
    <div class="rounded-2xl bg-white border border-gray-100 shadow-sm p-4">
      <div class="flex items-center justify-between">
        <div class="text-base font-semibold text-gray-900">{{ $t('nav.myOrders') }}</div>
    ...
    <div class="space-y-3">
      ...
      >
        <div class="p-3">
          ...
          <div class="mt-2 flex items-center justify-between">
            <div class="text-sm font-semibold text-gray-900">{{ $t('common.currency') }}{{ o.amount }}</div>
      ...
      <div v-if="!loading && orders.length === 0" class="rounded-2xl bg-white border border-gray-100 shadow-sm p-6 text-sm text-gray-500 text-center">
        {{ $t('common.noData') }}
      </div>
    </div>
