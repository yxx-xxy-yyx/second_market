  ...
  <div class="h-[100dvh] bg-gray-50">
    ...
    >
      <section class="w-full flex-none h-full snap-start relative swipe-section">
        ...
        <div class="absolute top-0 left-0 right-0 px-6 z-10" :style="{ paddingTop: 'calc(env(safe-area-inset-top) + 16px)' }">
        ...
        <div class="h-full flex items-center justify-center px-10 relative z-10">
          <div class="w-full max-w-[1080px] grid grid-cols-12 gap-8 items-center">
            ...
            <div class="col-span-5">
              <div class="rounded-3xl bg-[rgba(15,23,42,0.24)] border border-[rgba(255,255,255,0.20)] shadow-sm p-6 backdrop-blur">
                <div class="text-white text-xl font-extrabold">{{ $t('common.login') }}</div>
                <div class="mt-5 space-y-3">
                  <div class="rounded-2xl bg-[rgba(255,255,255,0.12)] border border-[rgba(255,255,255,0.16)] px-4 py-4 text-white/70">
                ...
                <button
                  class="mt-6 w-full py-3.5 rounded-2xl text-white font-semibold active:scale-[0.99] transition"
                ...
                <div class="mt-6 flex items-center justify-center gap-2">
                  <span class="h-1.5 rounded-full transition-all" :class="activeIndex === 0 ? 'w-6 bg-white' : 'w-2 bg-white/60'"></span>
                  <span class="h-1.5 rounded-full transition-all" :class="activeIndex === 1 ? 'w-6 bg-white' : 'w-2 bg-white/60'"></span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="w-full flex-none h-full snap-start bg-white swipe-section relative">
        <div class="absolute -left-16 bottom-10 w-56 h-56 rounded-full bg-[rgba(6,182,212,0.16)] blur-2xl" aria-hidden="true"></div>
        <div class="absolute right-8 top-28 w-44 h-44 rounded-full bg-[rgba(255,166,0,0.16)] blur-2xl" aria-hidden="true"></div>
            ...
            <div class="mx-auto max-w-[1080px] rounded-3xl bg-white border border-gray-100 shadow-sm overflow-hidden">
              <div class="grid grid-cols-12 min-h-[560px]">
                ...
                <div class="col-span-7 relative">
                  ...
                  <div class="absolute inset-0 bg-gradient-to-br from-[rgba(2,132,199,0.88)] to-[rgba(79,70,229,0.78)]" aria-hidden="true"></div>
                  <div class="relative h-full p-10 text-white">
                    ...
                    <div class="absolute bottom-8 left-10 text-xs text-white/60">Copyright © {{ new Date().getFullYear() }}</div>
                  </div>
                </div>
              </div>
            </div>
