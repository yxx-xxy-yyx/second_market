                ...
                >
                  ...
                  <div class="order-content">
                    <div class="product-info" @click.stop="handleViewProduct(order.productId)">
                      <el-image
                        :src="getProductImage(order.productImages)"
                        fit="cover"
                        class="product-image"
                      >
                        <template #error>
                      ...
                      <div class="product-details">
                        <div class="product-title">{{ locale === 'ko' && order.productTitleKo ? order.productTitleKo : order.productTitle }}</div>
                  ...
                  <div class="order-content">
                    <div class="product-info" @click.stop="handleViewProduct(order.productId)">
                      ...
                      <div class="product-details">
                        <div class="product-title">{{ locale === 'ko' && order.productTitleKo ? order.productTitleKo : order.productTitle }}</div>
                        <div class="product-meta">
                          <el-tag size="small">{{ order.productCategory ? $t('categories.' + order.productCategory) : $t('categories.others') }}</el-tag>
                          <span class="order-time">{{ formatTime(order.createTime) }}</span>
                        </div>
                      </div>
                    </div>
              ...
              <div class="trade-stats-panel">
                ...
                <el-card class="quick-actions-card" shadow="hover">
                  ...
                  <div class="quick-actions">
                    ...
                    <div class="quick-action-item">
                      <el-icon :size="32" color="#ff9800"><Money /></el-icon>
      ...
      <div class="order-detail" v-if="selectedOrder">
        ...
        <div class="detail-section">
          <div class="detail-status">
            <el-result
              ...
              :title="getStatusText(selectedOrder.status)"
        ...
        <div class="detail-section">
          ...
          <div class="detail-product">
            <el-image
              :src="getProductImage(selectedOrder.productImages)"
              fit="cover"
              class="detail-product-image"
            >
            </el-image>
            <div class="detail-product-info">
              <div class="detail-product-title">{{ locale === 'ko' && selectedOrder.productTitleKo ? selectedOrder.productTitleKo : selectedOrder.productTitle }}</div>
        ...
        <div class="detail-section">
          ...
          <div class="detail-info-list">
            <div class="info-item">
              ...
              <span class="info-value">{{ selectedOrder.orderNumber || selectedOrder.orderNo || selectedOrder.id }}</span>
            </div>
            <div class="info-item">
        ...
        <div class="detail-actions">
          <el-button
            v-if="selectedOrder.status === 0 && activeTab === 'buyer'"
            type="warning"
            size="large"
          ...
          <el-button
            v-if="selectedOrder.status === 1 && activeTab === 'buyer'"
            type="success"
            size="large"
          ...
          <el-button
            v-if="selectedOrder.status === 2 && activeTab === 'buyer'"
            type="primary"
            size="large"
          ...
          <el-button
            size="large"
            @click="handleViewProduct(selectedOrder.productId)"
          >
            <el-icon><View /></el-icon>
            {{ $t('common.view') }}
          </el-button>
