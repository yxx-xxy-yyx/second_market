<template>
  <div class="product-list-page">
      ...
      <div class="content-area">
        ...
        <div class="toolbar">
          <div class="toolbar-left">
            <span class="result-count">{{ $t('product.found') }} <strong>{{ total }}</strong> {{ $t('product.items') }}</span>
          ...
          <div class="toolbar-right">
            <el-select v-model="filters.sortBy" :placeholder="$t('product.sortBy')" size="default" @change="handleFilterChange">
              ...
              <div v-loading="loading" class="product-list">
                      ...
                      >
                        <template #reference>
                          <div class="product-image-wrapper" @click="handleProductClick(product.id)">
                            <img :src="getProductImage(product.images)" :alt="product.title" class="product-image" @error="handleImgError" />
                            ...
                            <div class="product-actions">
                              <el-button 
                                circle 
                                size="small"
                                :type="isInCompare(product.id) ? 'primary' : 'default'"
                        ...
                        <div class="quick-preview">
                          ...
                          <el-button type="primary" size="small" class="preview-btn" @click="handleProductClick(product.id)">
                      ...
                      <div class="product-info" @click="handleProductClick(product.id)">
                        ...
                        <div class="product-meta">
                          <div class="product-condition">
                            ...
                            <el-progress
                              :percentage="product.conditionScore * 10"
                              :show-text="false"
                              :stroke-width="4"
                              color="#409eff"
                            />
                      ...
                      >
                        <div class="product-card">
                          <div class="product-image-wrapper" @click="handleProductClick(p.id)">
                            <img :src="getProductImage(p.images)" :alt="p.title" class="product-image" @error="handleImgError" />
                          </div>
                ...
                <div class="pagination" v-if="total > 0">
                  <div class="custom-pagination">
                    <!-- 总数 -->
                    <span class="pagination-total">{{ $t('pagination.total') }} {{ total }} {{ $t('pagination.items') }}</span>
              ...
              <div class="recommend-sidebar">
                <div class="sidebar-section">
                  <div class="sidebar-title">
                    <el-icon color="#ff9800"><Star /></el-icon>
                  ...
                  <div class="recommend-list">
                    ...
                    >
                      ...
                      <div class="recommend-info">
                        <div class="recommend-title">{{ locale === 'ko' && item.titleKo ? item.titleKo : item.title }}</div>
                ...
                <div class="sidebar-section">
                  ...
                  <div class="latest-list">
                    <div 
                      v-for="item in latestProducts.slice(0, 4)" 
                      :key="item.id"
                      class="latest-item"
                      @click="handleProductClick(item.id)"
                    >
                      ...
                      <div class="latest-info">
                        <div class="latest-title">{{ locale === 'ko' && item.titleKo ? item.titleKo : item.title }}</div>
    ...
    <el-drawer
      ...
      :title="$t('product.compareProducts')"
      direction="rtl"
      size="60%"
    >
      <div class="compare-content" v-if="compareList.length > 0">
        <el-alert 
          ...
          :title="$t('product.atLeastTwoProducts')"
          type="warning"
          :closable="false"
            ...
            <el-card class="compare-card">
              ...
              <div class="compare-card-body">
                ...
                <div class="compare-item">
                  ...
                  <span class="compare-value">{{ product.originalPrice ? $t('common.currency') + product.originalPrice : $t('common.none') }}</span>
                </div>
                <div class="compare-item">
                ...
                <div class="compare-item">
                  ...
                  <span class="compare-value">{{ product.category ? $t(`categories.${product.category}`) : $t('categories.others') }}</span>
                </div>
