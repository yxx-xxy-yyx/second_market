            ...
            <el-card class="message-detail-card" shadow="hover">
              ...
              <div class="chat-container" v-if="isChatMode">
                <div class="chat-messages-box" ref="chatBox">
                  ...
                  <div v-for="(msg, index) in chatMessages" :key="index" :class="['chat-msg-item', msg.fromId === userStore.user.id ? 'sent' : 'received']">
                    <el-avatar :size="32" :src="msg.fromId === userStore.user.id ? formatAvatar(userStore.user.avatar) : formatAvatar(chatTarget.avatar)" />
