    ...
    <div class="mx-auto max-w-[980px] space-y-4">
      <div class="rounded-2xl bg-white border border-gray-100 shadow-sm p-5">
        <div class="flex items-center justify-between">
          <div>
            <div class="text-lg font-semibold text-gray-900">{{ $t('favorites.pageTitle') }}</div>
            <div class="text-sm text-gray-500 mt-1">{{ $t('favorites.subtitle') }}</div>
          </div>
      ...
      <div v-else class="grid grid-cols-2 gap-4">
        ...
        <div v-if="products.length === 0" class="col-span-2 rounded-2xl bg-white border border-gray-100 shadow-sm p-6 text-sm text-gray-500 text-center">
