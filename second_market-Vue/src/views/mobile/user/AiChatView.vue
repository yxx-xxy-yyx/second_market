<template>
  <div class="chat-wrapper bg-[#f8fafc]">
    ...
    <div
      class="top-nav-placeholder relative bg-white/80 backdrop-blur-xl px-4 flex items-center justify-center border-b border-gray-100 z-20">
      <div class="absolute left-4 w-10 h-10 flex items-center justify-center rounded-full active:bg-gray-100 cursor-pointer"
        @click="router.back()">
        <el-icon :size="20">
          <ArrowLeft />
        </el-icon>
      </div>
      <div class="absolute right-4 w-10 h-10"></div>
    ...
    <div
      ...
      <div v-if="aiLoading" class="status-banner px-4 py-2 text-sm text-slate-600 bg-slate-50 border-t border-gray-100">
        AI 正在思考，请稍候...
      </div>
