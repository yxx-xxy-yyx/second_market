<template>
  <div class="user-dashboard">
        ...
        <el-col :xs="24" :sm="24" :md="10" :lg="10">
          ...
          <div class="quick-categories">
            ...
            <div class="quick-category-list">
              <div v-for="(category, index) in categories.slice(0, 8)" :key="category.id" class="quick-category-item"
                @click="handleCategoryClick(category.id)">
                <div class="category-icon-wrapper" :style="getCategoryIconStyle(index)">
                  <CategoryIcon :category-id="category.id" :size="18" style="color: #fff" />
                </div>
      ...
      <el-row :gutter="15" class="middle-section">
          ...
          <div class="hot-products-section">
            <div class="section-header">
              <div class="header-left">
                <el-icon class="title-icon" color="#ff6b6b" :size="24">
                  <TrendCharts />
                </el-icon>
        ...
        <el-col :xs="24" :sm="24" :md="7" :lg="7">
          <div class="trade-dynamic-section">
            <div class="section-header">
              <div class="header-left">
                <el-icon class="title-icon" color="#67c23a" :size="20">
                  <Clock />
                </el-icon>
      ...
      <el-row :gutter="15" class="bottom-section">
        ...
        <el-col :span="24">
          <div class="recommend-section">
            <div class="section-header">
              <div class="header-left">
                <el-icon class="title-icon" color="#409eff" :size="24">
                  <Goods />
                </el-icon>
            ...
            <el-row :gutter="12" v-loading="loading">
              <el-col v-for="product in recommendProducts.slice(0, 12)" :key="product.id" :xs="12" :sm="8" :md="6"
                :lg="4">
    ...
    <!-- 公告详情抽屉 -->
    <el-drawer v-model="showNoticeDrawer" :title="$t('dashboard.notice')" direction="rtl" size="450px">
    ...
    <!-- 公告详情对话框 -->
    <el-dialog v-model="showNoticeDetail" :title="selectedNotice?.title" width="600px">
...
const categoryIconStyles = [
  ...
  'linear-gradient(135deg, #f56c6c 0%, #ff8a89 100%)',
  'linear-gradient(135deg, #9155fd 0%, #b76bff 100%)',
  'linear-gradient(135deg, #13c2c2 0%, #36d3d3 100%)',
  'linear-gradient(135deg, #ff7f50 0%, #ffb066 100%)',
  'linear-gradient(135deg, #00b96b 0%, #52c41a 100%)'
]

const getCategoryIconStyle = (index) => ({
  background: categoryIconStyles[index % categoryIconStyles.length],
  color: '#fff'
})
