<template>
  <div class="product-detail-page">
    <div class="detail-container" v-loading="loading">
      <template v-if="product">
            ...
            <div class="header-left">
              ...
              <div class="product-tags">
                ...
                <el-button
                  ...
                  type="success" size="small" @click="handleRequestAiAnalysis" class="header-ai-trigger-btn">
                  <el-icon>
                    <MagicStick />
                  </el-icon>
                  {{ $t('product.evaluate') }}
            ...
            <div class="header-right">
              ...
              <div class="header-stats">
                <div class="header-stat-item">
                  ...
                  <el-rate v-model="product.conditionScore" disabled show-score :max="10" text-color="#ff9800"
                    size="small" />
                </div>
                <div class="header-stat-item">
        ...
        <el-row :gutter="15" class="detail-main" style="margin-top: 15px; display: flex; align-items: stretch;">
          ...
          <!-- 中间：商品信息和AI评估 30% -->
          <el-col :xs="24" :sm="24" :md="7" :lg="7" class="middle-info-col">
            <div style="display: flex; flex-direction: column; height: 100%;">
              ...
              <el-card class="ai-analysis-card" shadow="hover" :body-style="{ padding: '12px' }">
                <template #header>
                  <div class="card-header ai-header">
                    ...
                    <el-button v-if="!aiAnalysisData && product.images && userStore.isLoggedIn && !aiAnalyzing"
                      type="primary" size="small" @click="handleRequestAiAnalysis" class="header-ai-btn">
                      <el-icon>
                        <MagicStick />
                      </el-icon>
              ...
              <!-- 商品详情卡片 -->
              <el-card class="desc-card" shadow="hover" style="margin-top: 15px; flex: 1;"
                ...
                <div class="desc-content">
                  <div class="desc-section">
                    ...
                    <p>{{ (locale === 'ko' && product.descriptionKo ? product.descriptionKo : product.description) ||
                      (locale ===
                        'zh' ? $t('product.noDesc') : $t('product.noDescKo')) }}</p>
                  </div>
                  <el-divider style="margin: 12px 0;" />
                  <div class="desc-section">
                    <h4>{{ $t('product.productCondit') }}</h4>
                    <p>{{ product.conditionDesc || (locale === 'zh' ? $t('product.noConditionDesc') :
                      $t('product.noConditionDescKo')) }}</p>
                  </div>
                  <el-divider style="margin: 12px 0;" />
                  <div class="desc-section">
          ...
          <!-- 右侧：操作区域 30% -->
          <el-col :xs="24" :sm="24" :md="7" :lg="7" class="right-action-col">
                ...
                <div class="seller-info" @click="showSellerDrawer = true">
                  ...
                  <div class="seller-details">
                    ...
                    <div class="seller-rating">
                      <el-rate v-model="sellerRating.averageRating" disabled size="small" show-score
                        text-color="#ff9800" />
                    </div>
              ...
              <el-card class="tab-content" shadow="never">
                <template #header>
                  <div class="reviews-header">
                    ...
                    <el-button type="primary" size="small" @click="goToReviews" v-if="reviews.length > 0">
                      <el-icon>
                        <View />
                      </el-icon>
                  ...
                  <div v-for="review in reviews.slice(0, 3)" :key="review.id" class="review-item">
                    <div class="review-header">
                      ...
                      <div class="review-user">
                        <div class="review-username">{{ review.reviewerNickname || review.username ||
                          $t('product.anonymousUser') }}</div>
    ...
    <!-- 卖家详情抽屉 -->
    <el-drawer v-model="showSellerDrawer" :title="$t('product.sellerHomepage')" direction="rtl" size="450px">
...
const fetchProductDetail = async () => {
  ...
  try {
    ...
    if (res.code === '200') {
      ...
      fetchReviews()
      fetchSellerProducts()
      if (userStore.isLoggedIn && product.value && product.value.id) {
        try {
          await browseApi.add(product.value.id)
        } catch (error) {
