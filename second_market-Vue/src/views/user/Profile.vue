<template>
  <div class="profile-page">
              ...
              <el-col :xs="24" :sm="12" :md="12" :lg="12">
                <el-card class="credit-card">
                  ...
                  <div class="credit-content">
                    ...
                    <el-rate v-model="creditStars" disabled show-score text-color="#ff9900" score-template="{value}"
                      size="large" />
                    <div class="credit-desc">{{ $t('profile.basedOn') }} {{ statistics.reviewCount || 0 }} {{
                      $t('profile.reviews') }}
                    </div>
                  </div>
                </el-card>
    ...
    <el-dialog v-model="showEditDialog" :title="$t('profile.editInfo')" width="500px" :close-on-click-modal="false">
