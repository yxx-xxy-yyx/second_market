...
const NeoErrandsListEntry = () => import('@/neo/views/errand/NeoErrandsListEntry.vue')
const NeoErrandNewEntry = () => import('@/neo/views/errand/NeoErrandNewEntry.vue')
const NeoErrandDetailEntry = () => import('@/neo/views/errand/NeoErrandDetailEntry.vue')
const NeoForumListEntry = () => import('@/neo/views/forum/NeoForumListEntry.vue')
const NeoForumNewEntry = () => import('@/neo/views/forum/NeoForumNewEntry.vue')
const NeoForumDetailEntry = () => import('@/neo/views/forum/NeoForumDetailEntry.vue')
